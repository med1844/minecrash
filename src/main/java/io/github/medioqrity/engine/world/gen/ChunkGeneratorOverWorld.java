...
import io.github.medioqrity.engine.maths.NoiseMath;
import io.github.medioqrity.engine.world.BiomeBase;
...
//        this.biomesForGeneration = this.world.getBiomeProvider().getBiomesForGeneration(this.biomesForGeneration, x * 4 - 2, z * 4 - 2, 10, 10);
    ...
    private void generateHeightmap(int x, int y, int z) {
        ...
        double coordinateScale = ChunkGeneratorOverWorld.coordinateScale;
        double heightScale = ChunkGeneratorOverWorld.heightScale;
        this.mainNoiseRegion = this.mainPerlinNoise.generateNoiseOctaves(this.mainNoiseRegion, x, y, z, 5, 33, 5,
                coordinateScale / mainNoiseScaleX, heightScale / mainNoiseScaleY,
                coordinateScale / mainNoiseScaleZ, persistence);

        this.minLimitRegion = this.minLimitPerlinNoise.generateNoiseOctaves(this.minLimitRegion, x, y, z, 5, 33, 5,
                coordinateScale, heightScale, coordinateScale, persistence);
